...
import { UserPlus, Search, Phone, Mail, Pencil } from 'lucide-react';
...
import { listParents } from '@/services/usersService';
    ...
    render: (_v, row) => (
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-[#64748B]">{relLabel[row.relationship] || row.relationship}</p>
        </div>
      </div>
    ),
  },
    ...
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-[#64748B]">{parents.length} phụ huynh</p>
        </div>
